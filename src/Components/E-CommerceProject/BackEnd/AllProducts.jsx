...
export default function AllProducts() {
  ...
  // ////////////// //////////////
  const { isProducts, isDeleteProduct, setIsDeleteProduct } =
  ...
  function editProduct(editProduct) {
    ...
    localStorage.setItem("currentEditProduct", JSON.stringify(editProduct));
    navigate("/dashboard/updateProduct");
  }

  const removeProduct = async ({ productId, productTitle }) => {
    const confirmation = confirm(
      `Do you Want to delete this ? ${productTitle}`
    );
    if (confirmation) {
